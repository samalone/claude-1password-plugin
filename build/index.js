...
server.registerTool("op-item-list", {
    ...
    inputSchema: {
        ...
        categories: z
            .string()
            .optional()
            .describe("Comma-separated category filter (e.g. 'Login,Password,API Credential')"),
        tags: z
            .string()
            .optional()
...
server.registerTool("op-item-create", {
    ...
    inputSchema: {
        category: z
            .string()
            .describe("Item category (e.g. Login, Password, 'API Credential', 'Secure Note', 'SSH Key')"),
        ...
        generatePassword: z
            .string()
            .optional()
            .describe("Password recipe (e.g. '20,letters,digits' or just 'true' for default)"),
        tags: z
            .string()
            .optional()
        ...
        fields: z
            .array(z.string())
            .optional()
            .describe("Assignment statements for fields (e.g. ['username=admin', 'server.host[text]=10.0.0.1'])"),
    },
...
server.registerTool("op-item-edit", {
    ...
    inputSchema: {
        ...
        fields: z
            .array(z.string())
            .optional()
            .describe("Assignment statements for fields (e.g. ['username=newuser', 'password=newsecret'])"),
    },
...
server.registerTool("op-item-delete", {
    ...
    inputSchema: {
        ...
        archive: z
            ...
            .optional()
            .default(true)
            .describe("Archive instead of permanently deleting (default: true for safety)"),
    },
...
server.registerTool("op-read", {
    ...
    inputSchema: {
        reference: z
            .string()
            .regex(/^op:\/\//)
            .describe("Secret reference URI (e.g. op://vault/item/field)"),
        account: z
            .string()
            .optional()
            .describe("Account URL or User ID"),
